  ...
  return (
    ...
    >
      <motion.div
        ...
        className={`flex flex-col relative -top-[25%] h-[330px] md:h-[400px] lg:h-[450px] w-[100%] md:w-[85%] lg:w-[70%] rounded-md p-4 md:p-10 origin-top`}
      >
        <h2 className="text-2xl text-center font-semibold">{title}</h2>
        <div className={`flex h-full mt-5 gap-10`}>
          <div className={`w-[60%] relative top-[10%]`}>
